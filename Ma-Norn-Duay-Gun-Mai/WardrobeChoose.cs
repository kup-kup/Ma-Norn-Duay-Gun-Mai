...
{
    public partial class WardrobeChoose : Form
    {
        ...
        private void WardrobeChoose_Load(object sender, EventArgs e)
        {
        ...
        {
            GlobalVar.wardrobe_op = 2;
        }

        private void radioButton3_CheckedChanged(object sender, EventArgs e)
        {
            GlobalVar.wardrobe_op = 3;
        }

        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            GlobalVar.wardrobe_op = 4;
        }
    }
}
